...
const CreatePost = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      >
        <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-red-700 mb-6">Create a New Post</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-1 text-center">
                ...
                {imagePreviews.length > 0 && (
                  ...
                  >
                    ...
                    <span>Add More Images ({selectedImages.length}/5)</span>
                  </motion.button>
                )}
              </div>
            </motion.div>
          ...
          <div className="flex justify-end space-x-4">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              disabled={isSubmitting || !text.trim() || selectedImages.length === 0}
              className={`px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-red-600 to-red-800 hover:from-red-700 hover:to-red-900 rounded-lg transition-all duration-200 shadow-lg shadow-red-900/30 hover:shadow-red-900/50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-gray-900 ${
                (isSubmitting || !text.trim() || selectedImages.length === 0) && 'opacity-50 cursor-not-allowed'
              }`}
            >
              {isSubmitting ? (
